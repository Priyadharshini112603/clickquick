        ...
        <div class="col-5 text-left">
          ...
          <br>
             ...
             <div class="form-group">
              ...
              <label class="form"  for="exampleInputEmail1">Name</label>
              <input
                type="text"
                class="form-control"
            ...
            <div class="form-group">
              ...
              <label class="form"  for="exampleInputEmail1">Email</label>
              <input
                type="email"
                class="form-control"
                id="exampleInputEmail1"
            ...
            <div class="form-group">
              ...
              <label class="form"  for="exampleInputEmail1">Password</label>
              <input
                type="password"
                class="form-control"
                id="exampleInputEmail1"
            ...
            <div class="form-group">
              ...
              <label class="form"  for="exampleInputEmail1">Retype Password</label>
              <input
                type="password"
                class="form-control"
                id="exampleInputEmail1"
              ...
              <div class="form-group">
                 <center>
                        ...
                        <router-link to="/UserLogin" ><button type="submit" class="btn btn-primary btn-block">Register</button></router-link> 
              ...
              <p>Create an Account</p> -->
               <div class="form-group">
                 ...
                 <button  type="submit" class="btn btn-primary btn-block">Login as User</button></router-link>
